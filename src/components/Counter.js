...
const Counter = (props) => {
const totalBills = props.ones + props.fives + props.tens + props.twenties + props.fifties + props.hundreds;
...
const totalAmount =props.ones + totalFives + totalTens + totalTwenties + totalFifties + totalHundreds;
